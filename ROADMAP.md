...
| Publication | Verified runtime, matching screenshots/docs, credits, checksums and honest known issues on GitHub | 0.5.5 castle/prison/daylight-lighting batch verified, installed and published on 18 September; anonymous release and checksum checks passed; subsequent release work remains |
