...
| Caves and exploration | Natural interiors, readable landmarks and safe connected passages | 0.5.9 buries entrances, adds continuous underground loops and waterfall-pool swimming; route, descent and pool-exit checks pass; full ordinary exploration acceptance remains |
...
| Publication | Verified runtime, matching screenshots/docs, credits and checksums | 0.5.9: 288 packaged checks, complete descent walk, seven reviewed views and save-preserving installation; wider ordinary-play and hardware acceptance remain |
